...
class WindsurfRegister(BaseTask):
    def __init__(self, config: TaskConfig, global_config: Dict):
        super().__init__(config, global_config)
        self.signup_url = global_config.get("ai_services", {}).get("windsurf", {}).get("signup_url", "https://windsurf.ai")
        ...
        try:
            ...
            with Camoufox(**launch_opts) as browser:
                ...
                try:
                    ...
                    page.get_by_role("button", name="Download").wait_for(timeout=5000)
                ...
                return TaskResult(
                    ...
                    message=f"Windsurf page opened: {email}",
                    data={"email": email}
                )
