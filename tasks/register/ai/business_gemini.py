...
class BusinessGeminiRegister(BaseTask):
    def __init__(self, config: TaskConfig, global_config: Dict):
        super().__init__(config, global_config)
        self.signup_url = global_config.get("ai_services", {}).get("business_gemini", {}).get("signup_url", "https://ai.google.dev")
        ...
        try:
            ...
            with Camoufox(**launch_opts) as browser:
                ...
                return TaskResult(
                    ...
                    message=f"Business Gemini page opened: {email}",
                    data={"email": email}
                )
