...
class NvidiaRegister(BaseTask):
    def __init__(self, config: TaskConfig, global_config: Dict):
        super().__init__(config, global_config)
        self.signup_url = global_config.get("ai_services", {}).get("nvidia", {}).get("signup_url", "https://ngc.nvidia.com")
        ...
        try:
            ...
            with Camoufox(**launch_opts) as browser:
                ...
                return TaskResult(
                    ...
                    message=f"NVIDIA registration started: {email}",
                    data={"email": email}
                )
