...
class MistralRegister(BrowserTask):
    ...
    def execute(self) -> TaskResult:
        ...
        self.log_action_start("mistral_register", f"Registering Mistral account: {email}")
        ...
        try:
            ...
            with Camoufox(**launch_opts) as browser:
                ...
                self.log_action_end("mistral_register", f"Mistral registration started: {email}", True)
            ...
            self.logger.error(f"Mistral registration failed: {str(e)}")
            self.logger.perf_metrics.end()
            self.log_action_end("mistral_register", str(e), False)
            return TaskResult(
                task_id=self.config.task_id,
