...
class OpenCodeRegister(BaseTask):
    def __init__(self, config: TaskConfig, global_config: Dict):
        super().__init__(config, global_config)
        self.signup_url = global_config.get("ai_services", {}).get("opencode", {}).get("signup_url", "https://opencode.ai")
        ...
        try:
            ...
            with Camoufox(**launch_opts) as browser:
                ...
                return TaskResult(
                    ...
                    message=f"OpenCode registration started: {email}",
                    data={"email": email}
                )
